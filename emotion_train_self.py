...
class Model:
    ...
    def build_model(self):
        ...
        self.model.add(Conv2D(32, (1, 1), strides=1,
    ...
    def train_model(self):
        ...
        self.model.compile(loss='categorical_crossentropy',
                           ...
                           # optimizer='rmsprop',
                           metrics=['accuracy'])
        # Automatically expand training samples
        ...
        eval_datagen = ImageDataGenerator(
            rescale=1. / 255)
        # Divide by file classification name
        ...
        # print("%s: %.2f%%" %
        #      (self.model.metrics_names[1], history_eval[1] * 100))
        print('model trained')
